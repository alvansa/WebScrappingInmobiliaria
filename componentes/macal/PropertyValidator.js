...
class Property {
    ...
    static validationSchema = Joi.object({
        ...
        property_type: Joi.string().valid(
            ...
            'INDUSTRIAL', 'LOCAL COMERCIAL', 'PARCELA', 'TERRENO'
        ).required(),
        ...
        // Dimensions
        property_dimensions: Joi.string().trim().pattern(/^[\d\.]+\s*(m2|ha)$/),
        ...
        // Computed fields
        computed: Joi.object({
            area_square_meters: Joi.number().positive().optional(),
    ...
    toJSON() {
        return {
            ...this,
            computed: {
                area_square_meters: this.getAreaInSquareMeters(),
